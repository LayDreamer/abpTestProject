...
public class LocalTestEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<LocalTestDbContext>(options =>
        {
        ...
        context.Services.AddTreeRepository<LocalTestDbContext>();

        Configure<AbpDbContextOptions>(options =>
        {
            /* The main point to change your DBMS.
             * See also LocalTestMigrationsDbContextFactory for EF Core tooling. */
            options.UseMySQL();
        });
